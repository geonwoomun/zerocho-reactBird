        ...
        {post.RetweetId && post.Retweet ? (
          ...
          >
            <Card.Meta
              ...
              description={<PostCardContent postData={post.Retweet.content} />} // a tag x -> Link 태크로 바꿔주기. next에서는 a tag 쓰지말고 link로 해야 spa가 유지된다.
            />
          </Card>
        ) : (
          <Card.Meta // 서버 주소라서 새로고침하게된다. 밑에처럼 프론트에서 처리할 수 있게 바꿔줘야함.
            ...
            description={<PostCardContent postData={post.content} />} // a tag x -> Link 태크로 바꿔주기. next에서는 a tag 쓰지말고 link로 해야 spa가 유지된다.
          />
        )}
      </Card>
      {commentFormOpend && (
